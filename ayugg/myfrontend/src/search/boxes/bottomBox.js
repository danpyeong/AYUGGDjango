...
function BottomBox() {
  ...
  return (
    <div>
      <MatchButtons>
        <MatchButton value={selectedButton} isclick={'whole'}>전체</MatchButton>
        <MatchButton value={selectedButton} isclick={'solo'}>솔로 랭크</MatchButton>
        <MatchButton value={selectedButton} isclick={'team'}>자유 랭크</MatchButton>
        <MatchButton value={selectedButton} isclick={'normal'}>일반</MatchButton>
      </MatchButtons>
      <BlankDiv />
